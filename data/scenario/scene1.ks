...
;ここからデバッグ用シナリオジャンプ
[if exp="sf.debug"]
[glink storage=scenario01_prologue.ks text="scenario01_prologue" size=20 width=500 x=30 y=100 color=blue  ]
[glink storage=scenario02_ki.ks text="scenario02_ki" size=20 width=500 x=30 y=160 color=blue  ]
[glink storage=scenario03_ep01.ks text="scenario03_ep01" size=20 width=500 x=30 y=220 color=blue  ]
[glink storage=scenario04_im01kyoko.ks text="scenario04_im01kyoko" size=20 width=500 x=30 y=280 color=blue  ]
[glink storage=scenario05_ep02.ks text="scenario05_ep02" size=20 width=500 x=30 y=340 color=blue  ]
[glink storage=scenario06_im02mami.ks text="scenario06_im02mami" size=20 width=500 x=30 y=400 color=blue  ]
[glink storage=scenario07_ep03.ks text="scenario07_ep03" size=20 width=500 x=30 y=460 color=blue  ]
[glink storage=scenario08_im03nagisa.ks text="scenario08_im03nagisa" size=20 width=500 x=30 y=520 color=blue  ]
[glink storage=scenario09_ep07.ks text="scenario09_ep07" size=20 width=500 x=30 y=580 color=blue  ]
[glink storage=scenario10_im04sayaka.ks text="scenario10_im04sayaka" size=20 width=500 x=30 y=640 color=blue  ]

[glink storage=scenario11_ep05_01.ks text="scenario11_ep05_01" size=20 width=500 x=640 y=100 color=blue  ]
[glink storage=scenario12_im05madoka.ks text="scenario12_im05madoka" size=20 width=500 x=640 y=160 color=blue  ]
[glink storage=scenario13_ep06.ks text="scenario13_ep06" size=20 width=500 x=640 y=220 color=blue  ]
[glink storage=scenario14_ten01.ks text="scenario14_ten01" size=20 width=500 x=640 y=280 color=blue  ]
[glink storage=scenario15_im06homura.ks text="scenario15_im06homura" size=20 width=500 x=640 y=340 color=blue  ]
[glink storage=scenario16_ten02.ks text="scenario16_ten02" size=20 width=500 x=640 y=400 color=blue  ]
[glink storage=scenario17_ketsu.ks text="scenario17_ketsu" size=20 width=500 x=640 y=460 color=blue  ]
